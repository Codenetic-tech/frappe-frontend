  ...
  return (
    <div className="bg-card border border-border rounded-lg p-4 h-full flex flex-col min-h-0 overflow-hidden select-none transition-colors">
      ...
      <div className="flex items-center justify-between mb-2">
        <span className="text-xs font-semibold text-muted-foreground tracking-tight">Risk Focus</span>
      </div>
      ...
      {/* Under Funnel: Columns for the first 3 stages */}
      <div className="grid grid-cols-4 mt-3 shrink-0">

        {/* Column 1: Total in disk */}
        ...
        <div className="px-1 flex flex-col justify-between">
          <div className="flex items-center">
            <span className="inline-flex items-center gap-0.5 text-[9px] font-bold text-[#4ade80] leading-none">
              <TrendingDown className="w-2.5 h-2.5" /> -39%
            </span>
          </div>
        ...
        {/* Column 3: Executed at CPU */}
        <div className="px-1 flex flex-col justify-between">
          <div className="flex items-center">
            <span className="inline-flex items-center gap-0.5 text-[9px] font-bold text-[#4ade80] leading-none">
              <TrendingDown className="w-2.5 h-2.5" /> -53%
            </span>
          </div>
          <div className="text-[10px] text-muted-foreground font-semibold truncate leading-normal mt-1">
            Executed at CPU
        ...
        {/* Column 4: TotalVul. Functions Executed */}
        <div className="px-1 flex flex-col justify-between">
          <div className="flex items-center">
            <span className="inline-flex items-center gap-0.5 text-[9px] font-bold text-[#4ade80] leading-none">
              <TrendingDown className="w-2.5 h-2.5" /> -97%
            </span>
          </div>
          <div className="text-[10px] text-muted-foreground font-semibold truncate leading-normal mt-1">
            TotalVul. Functions Executed
          </div>
          <div className="text-[20px] font-bold text-foreground tracking-tight mt-1 leading-none">
            44
          </div>
